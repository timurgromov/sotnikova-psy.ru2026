...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Консультации проходят онлайн: Яндекс.Telemost, Zoom и другие платформы. Продолжительность одной встречи — 50–55 минут. Как правило, мы встречаемся один раз в неделю, а затем по совместному решению можем перейти на формат один раз в две недели.",
  },
  {
